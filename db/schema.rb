...
ActiveRecord::Schema.define(version: 20131115095305) do
  ...
  add_index "casts", ["movie_id", "person_id", "role"], name: "index_casts_on_movie_id_and_person_id_and_role", unique: true, using: :btree
